...
<body>
  ...
  <div id="content">
    <h2>Explanation of Increment Operators:</h2>
    <div class="explain">
      <span class="bold">1. Post-Increment</span> (i++):
      <ul>
      ...
      <br>
      <span class="bold">2. Pre-Increment</span> (++i):
      <ul>
      ...
      <br>
      <span class="bold">3. Addition Assignment</span> (i+=1):
      <ul>
